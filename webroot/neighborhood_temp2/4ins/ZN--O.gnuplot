...
set output "/var/www/html/csgid/app/webroot/neighborhood_temp/4ins/ZN--O.png"
...
set y2label "# of ZN--O interactions (4ins)" offset -40,4 rotate by 0
plot "-" using ($1+0.05):2 with boxes lc rgb "#801010" axis x1y2 title "4ins", \
     "/var/www/html/csgid/app/webroot/neighborhood_temp/csd_metal_distances/ZN--O.csv" using ($1+0.025):2 with linespoints linewidth 2 pointtype 7 pointsize 0.2 lc rgb "#074a7e" title "CSD^{5}" axis x1y1
2.1	3
2.3	3
e
