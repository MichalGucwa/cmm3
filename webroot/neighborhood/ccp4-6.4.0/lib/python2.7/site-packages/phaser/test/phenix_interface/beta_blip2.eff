...
phaser {
  ...
  crystal_symmetry {
    unit_cell = 75.11 75.11 133.31 90 90 120
  ...
  solution = "beta_solution.pkl"
  output_dir = None
  keywords {
    general {
      root = "blip_after_beta"
      title = "place blip, starting from beta solution"
      verbose = None
      debug = None
      mute = None
      xyzout = None
      xyzout_ensemble = None
      hklout = None
      jobs = 2
      keywords = False
    }
    ...
    tncs {
      ...
      rotation_grid = True
      patterson_hires = 5.0
      patterson_lores = 10.0
      patterson_percent = 20
      patterson_distance = 15
      variance_rmsd = 0.4
      variance_frac = 1.0
      link_restraint = True
      link_sigma = 0.1
