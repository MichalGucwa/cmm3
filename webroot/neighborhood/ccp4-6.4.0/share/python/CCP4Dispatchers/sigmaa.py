...
class Dispatcher:
    """A class to handle dispatch to 'sigmaa'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/sigmaa"
    ...
    def get_bin(self):
        """Method to get the path to 'sigmaa'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'sigmaa'"""
    ...
    def monitor(self):
        """
        Method to read output of sigmaa and check if it has finished.
