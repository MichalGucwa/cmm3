...
#
"""CCP4 dispatcher for 'percent-rank.pl'"""
...
class Dispatcher:
    """A class to handle dispatch to 'percent-rank.pl'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "percent-rank.pl"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/perl -w /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/percent-rank.pl"
    ...
    def get_bin(self):
        """Method to get the path to 'percent-rank.pl'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'percent-rank.pl'"""
    ...
    def call(self, wait=True):
        """
        Method to execute percent-rank.pl.
    ...
    def monitor(self):
        """
        Method to read output of percent-rank.pl and check if it has finished.
