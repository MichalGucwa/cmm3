...
class Dispatcher:
    """A class to handle dispatch to 'dtrek2mtz'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/dtrek2mtz"
    ...
    def get_bin(self):
        """Method to get the path to 'dtrek2mtz'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'dtrek2mtz'"""
    ...
    def monitor(self):
        """
        Method to read output of dtrek2mtz and check if it has finished.
