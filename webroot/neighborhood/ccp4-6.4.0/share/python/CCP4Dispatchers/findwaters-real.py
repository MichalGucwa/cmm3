...
#
"""CCP4 dispatcher for 'findwaters-real'"""
...
class Dispatcher:
    """A class to handle dispatch to 'findwaters-real'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "findwaters-real"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/findwaters-real"
    ...
    def get_bin(self):
        """Method to get the path to 'findwaters-real'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'findwaters-real'"""
    ...
    def call(self, wait=True):
        """
        Method to execute findwaters-real.
    ...
    def monitor(self):
        """
        Method to read output of findwaters-real and check if it has finished.
