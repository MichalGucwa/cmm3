...
class Dispatcher:
    """A class to handle dispatch to 'act'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/act"
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'act'"""
    ...
    def monitor(self):
        """
        Method to read output of act and check if it has finished.
