...
class Dispatcher:
    """A class to handle dispatch to 'znd_subs'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/znd_subs"
    ...
    def get_bin(self):
        """Method to get the path to 'znd_subs'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'znd_subs'"""
    ...
    def monitor(self):
        """
        Method to read output of znd_subs and check if it has finished.
