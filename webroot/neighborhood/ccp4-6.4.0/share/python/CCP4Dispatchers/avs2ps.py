...
class Dispatcher:
    """A class to handle dispatch to 'avs2ps'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/avs2ps"
    ...
    def get_bin(self):
        """Method to get the path to 'avs2ps'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'avs2ps'"""
    ...
    def monitor(self):
        """
        Method to read output of avs2ps and check if it has finished.
