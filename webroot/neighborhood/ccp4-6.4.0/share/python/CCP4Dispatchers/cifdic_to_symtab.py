...
#
"""CCP4 dispatcher for 'cifdic_to_symtab'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cifdic_to_symtab'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cifdic_to_symtab"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cifdic_to_symtab"
    ...
    def get_bin(self):
        """Method to get the path to 'cifdic_to_symtab'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cifdic_to_symtab'"""
    ...
    def call(self, wait=True):
        """
        Method to execute cifdic_to_symtab.
    ...
    def monitor(self):
        """
        Method to read output of cifdic_to_symtab and check if it has finished.
