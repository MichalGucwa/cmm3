...
#
"""CCP4 dispatcher for 'prosmart_restrain'"""
...
class Dispatcher:
    """A class to handle dispatch to 'prosmart_restrain'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "prosmart_restrain"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/prosmart_restrain"
    ...
    def get_bin(self):
        """Method to get the path to 'prosmart_restrain'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'prosmart_restrain'"""
    ...
    def call(self, wait=True):
        """
        Method to execute prosmart_restrain.
    ...
    def monitor(self):
        """
        Method to read output of prosmart_restrain and check if it has finished.
