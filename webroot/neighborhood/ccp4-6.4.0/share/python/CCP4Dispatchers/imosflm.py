...
class Dispatcher:
    """A class to handle dispatch to 'imosflm'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/imosflm"
    ...
    def get_bin(self):
        """Method to get the path to 'imosflm'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'imosflm'"""
    ...
    def monitor(self):
        """
        Method to read output of imosflm and check if it has finished.
