...
#
"""CCP4 dispatcher for 'JLogGraph.jar'"""
...
class Dispatcher:
    """A class to handle dispatch to 'JLogGraph.jar'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "JLogGraph.jar"

        # A string giving the command required for dispatch
        self.command = "java -jar /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/JLogGraph.jar"
    ...
    def get_bin(self):
        """Method to get the path to 'JLogGraph.jar'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'JLogGraph.jar'"""
    ...
    def call(self, wait=True):
        """
        Method to execute JLogGraph.jar.
    ...
    def monitor(self):
        """
        Method to read output of JLogGraph.jar and check if it has finished.
