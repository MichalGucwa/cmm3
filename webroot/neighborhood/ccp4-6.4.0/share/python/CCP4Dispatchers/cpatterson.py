...
#
"""CCP4 dispatcher for 'cpatterson'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cpatterson'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cpatterson"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cpatterson"
    ...
    def get_bin(self):
        """Method to get the path to 'cpatterson'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cpatterson'"""
    ...
    def monitor(self):
        """
        Method to read output of cpatterson and check if it has finished.
