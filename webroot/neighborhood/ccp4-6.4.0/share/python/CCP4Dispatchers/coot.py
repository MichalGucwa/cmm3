...
class Dispatcher:
    """A class to handle dispatch to 'coot'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/bash /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/coot"
    ...
    def get_bin(self):
        """Method to get the path to 'coot'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'coot'"""
    ...
    def monitor(self):
        """
        Method to read output of coot and check if it has finished.
