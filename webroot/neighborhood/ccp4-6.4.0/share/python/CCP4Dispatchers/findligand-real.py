...
#
"""CCP4 dispatcher for 'findligand-real'"""
...
class Dispatcher:
    """A class to handle dispatch to 'findligand-real'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "findligand-real"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/findligand-real"
    ...
    def get_bin(self):
        """Method to get the path to 'findligand-real'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'findligand-real'"""
    ...
    def call(self, wait=True):
        """
        Method to execute findligand-real.
    ...
    def monitor(self):
        """
        Method to read output of findligand-real and check if it has finished.
