...
#
"""CCP4 dispatcher for 'get_structure_DB'"""
...
class Dispatcher:
    """A class to handle dispatch to 'get_structure_DB'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "get_structure_DB"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/get_structure_DB"
    ...
    def get_bin(self):
        """Method to get the path to 'get_structure_DB'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'get_structure_DB'"""
    ...
    def call(self, wait=True):
        """
        Method to execute get_structure_DB.
    ...
    def monitor(self):
        """
        Method to read output of get_structure_DB and check if it has finished.
