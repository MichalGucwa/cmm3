...
#
"""CCP4 dispatcher for 'findligand'"""
...
class Dispatcher:
    """A class to handle dispatch to 'findligand'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "findligand"

        # A string giving the command required for dispatch
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/findligand"
    ...
    def get_bin(self):
        """Method to get the path to 'findligand'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'findligand'"""
    ...
    def monitor(self):
        """
        Method to read output of findligand and check if it has finished.
