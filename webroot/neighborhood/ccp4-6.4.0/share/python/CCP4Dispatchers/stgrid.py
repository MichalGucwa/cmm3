...
class Dispatcher:
    """A class to handle dispatch to 'stgrid'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/stgrid"
    ...
    def get_bin(self):
        """Method to get the path to 'stgrid'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'stgrid'"""
    ...
    def monitor(self):
        """
        Method to read output of stgrid and check if it has finished.
