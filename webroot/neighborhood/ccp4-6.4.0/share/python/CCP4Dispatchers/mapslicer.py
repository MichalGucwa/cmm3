...
class Dispatcher:
    """A class to handle dispatch to 'mapslicer'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mapslicer"
    ...
    def get_bin(self):
        """Method to get the path to 'mapslicer'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mapslicer'"""
    ...
    def monitor(self):
        """
        Method to read output of mapslicer and check if it has finished.
