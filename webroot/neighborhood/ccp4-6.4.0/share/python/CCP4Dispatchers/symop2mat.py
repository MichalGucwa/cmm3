...
class Dispatcher:
    """A class to handle dispatch to 'symop2mat'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/symop2mat"
    ...
    def get_bin(self):
        """Method to get the path to 'symop2mat'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'symop2mat'"""
    ...
    def monitor(self):
        """
        Method to read output of symop2mat and check if it has finished.
