...
#
"""CCP4 dispatcher for 'cphasecombine'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cphasecombine'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cphasecombine"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cphasecombine"
    ...
    def get_bin(self):
        """Method to get the path to 'cphasecombine'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cphasecombine'"""
    ...
    def call(self, wait=True):
        """
        Method to execute cphasecombine.
    ...
    def monitor(self):
        """
        Method to read output of cphasecombine and check if it has finished.
