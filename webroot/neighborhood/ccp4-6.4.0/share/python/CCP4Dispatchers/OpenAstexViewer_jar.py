...
#
"""CCP4 dispatcher for 'OpenAstexViewer.jar'"""
...
class Dispatcher:
    """A class to handle dispatch to 'OpenAstexViewer.jar'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "OpenAstexViewer.jar"

        # A string giving the command required for dispatch
        self.command = "java -jar /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/OpenAstexViewer.jar"
    ...
    def get_bin(self):
        """Method to get the path to 'OpenAstexViewer.jar'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'OpenAstexViewer.jar'"""
    ...
    def call(self, wait=True):
        """
        Method to execute OpenAstexViewer.jar.
    ...
    def monitor(self):
        """
        Method to read output of OpenAstexViewer.jar and check if it has finished.
