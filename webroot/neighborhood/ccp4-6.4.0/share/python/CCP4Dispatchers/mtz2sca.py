...
class Dispatcher:
    """A class to handle dispatch to 'mtz2sca'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mtz2sca"
    ...
    def get_bin(self):
        """Method to get the path to 'mtz2sca'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mtz2sca'"""
    ...
    def monitor(self):
        """
        Method to read output of mtz2sca and check if it has finished.
