...
class Dispatcher:
    """A class to handle dispatch to 'pdb2to3'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdb2to3"
    ...
    def get_bin(self):
        """Method to get the path to 'pdb2to3'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdb2to3'"""
    ...
    def monitor(self):
        """
        Method to read output of pdb2to3 and check if it has finished.
