...
class Dispatcher:
    """A class to handle dispatch to 'add_heavy'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/usr/bin/env tclsh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/add_heavy"
    ...
    def get_bin(self):
        """Method to get the path to 'add_heavy'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'add_heavy'"""
    ...
    def monitor(self):
        """
        Method to read output of add_heavy and check if it has finished.
