...
#
"""CCP4 dispatcher for 'pdb_extract_sf'"""
...
class Dispatcher:
    """A class to handle dispatch to 'pdb_extract_sf'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "pdb_extract_sf"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdb_extract_sf"
    ...
    def get_bin(self):
        """Method to get the path to 'pdb_extract_sf'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdb_extract_sf'"""
    ...
    def call(self, wait=True):
        """
        Method to execute pdb_extract_sf.
    ...
    def monitor(self):
        """
        Method to read output of pdb_extract_sf and check if it has finished.
