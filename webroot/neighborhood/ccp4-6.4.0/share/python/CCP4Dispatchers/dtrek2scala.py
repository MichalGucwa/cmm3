...
#
"""CCP4 dispatcher for 'dtrek2scala'"""
...
class Dispatcher:
    """A class to handle dispatch to 'dtrek2scala'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "dtrek2scala"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/dtrek2scala"
    ...
    def get_bin(self):
        """Method to get the path to 'dtrek2scala'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'dtrek2scala'"""
    ...
    def monitor(self):
        """
        Method to read output of dtrek2scala and check if it has finished.
