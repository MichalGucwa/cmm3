...
#
"""CCP4 dispatcher for 'convert2mtz'"""
...
class Dispatcher:
    """A class to handle dispatch to 'convert2mtz'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "convert2mtz"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/convert2mtz"
    ...
    def get_bin(self):
        """Method to get the path to 'convert2mtz'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'convert2mtz'"""
    ...
    def monitor(self):
        """
        Method to read output of convert2mtz and check if it has finished.
