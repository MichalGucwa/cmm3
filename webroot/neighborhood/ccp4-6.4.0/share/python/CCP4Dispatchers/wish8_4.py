...
class Dispatcher:
    """A class to handle dispatch to 'wish8.4'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/wish8.4"
    ...
    def get_bin(self):
        """Method to get the path to 'wish8.4'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'wish8.4'"""
    ...
    def monitor(self):
        """
        Method to read output of wish8.4 and check if it has finished.
