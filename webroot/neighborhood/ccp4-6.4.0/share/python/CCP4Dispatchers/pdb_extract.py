...
#
"""CCP4 dispatcher for 'pdb_extract'"""
...
class Dispatcher:
    """A class to handle dispatch to 'pdb_extract'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "pdb_extract"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdb_extract"
    ...
    def get_bin(self):
        """Method to get the path to 'pdb_extract'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdb_extract'"""
    ...
    def monitor(self):
        """
        Method to read output of pdb_extract and check if it has finished.
