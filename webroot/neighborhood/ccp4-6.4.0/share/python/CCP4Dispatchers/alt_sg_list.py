...
#
"""CCP4 dispatcher for 'alt_sg_list'"""
...
class Dispatcher:
    """A class to handle dispatch to 'alt_sg_list'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "alt_sg_list"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/alt_sg_list"
    ...
    def get_bin(self):
        """Method to get the path to 'alt_sg_list'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'alt_sg_list'"""
    ...
    def monitor(self):
        """
        Method to read output of alt_sg_list and check if it has finished.
