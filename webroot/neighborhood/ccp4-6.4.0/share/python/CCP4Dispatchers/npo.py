...
class Dispatcher:
    """A class to handle dispatch to 'npo'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/npo"
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'npo'"""
    ...
    def monitor(self):
        """
        Method to read output of npo and check if it has finished.
