...
class Dispatcher:
    """A class to handle dispatch to 'map2fs'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/map2fs"
    ...
    def get_bin(self):
        """Method to get the path to 'map2fs'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'map2fs'"""
    ...
    def monitor(self):
        """
        Method to read output of map2fs and check if it has finished.
