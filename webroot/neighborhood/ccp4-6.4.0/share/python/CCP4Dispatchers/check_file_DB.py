...
#
"""CCP4 dispatcher for 'check_file_DB'"""
...
class Dispatcher:
    """A class to handle dispatch to 'check_file_DB'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "check_file_DB"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/check_file_DB"
    ...
    def get_bin(self):
        """Method to get the path to 'check_file_DB'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'check_file_DB'"""
    ...
    def call(self, wait=True):
        """
        Method to execute check_file_DB.
    ...
    def monitor(self):
        """
        Method to read output of check_file_DB and check if it has finished.
