...
#
"""CCP4 dispatcher for 'fix-nomenclature-errors'"""
...
class Dispatcher:
    """A class to handle dispatch to 'fix-nomenclature-errors'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "fix-nomenclature-errors"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/fix-nomenclature-errors"
    ...
    def get_bin(self):
        """Method to get the path to 'fix-nomenclature-errors'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'fix-nomenclature-errors'"""
    ...
    def call(self, wait=True):
        """
        Method to execute fix-nomenclature-errors.
    ...
    def monitor(self):
        """
        Method to read output of fix-nomenclature-errors and check if it has finished.
