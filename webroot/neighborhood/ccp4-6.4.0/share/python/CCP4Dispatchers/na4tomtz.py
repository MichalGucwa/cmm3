...
class Dispatcher:
    """A class to handle dispatch to 'na4tomtz'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/na4tomtz"
    ...
    def get_bin(self):
        """Method to get the path to 'na4tomtz'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'na4tomtz'"""
    ...
    def monitor(self):
        """
        Method to read output of na4tomtz and check if it has finished.
