...
class Dispatcher:
    """A class to handle dispatch to 'mini-rsr'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mini-rsr"
    ...
    def get_bin(self):
        """Method to get the path to 'mini-rsr'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mini-rsr'"""
    ...
    def monitor(self):
        """
        Method to read output of mini-rsr and check if it has finished.
