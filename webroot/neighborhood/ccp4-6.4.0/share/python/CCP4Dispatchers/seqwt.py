...
class Dispatcher:
    """A class to handle dispatch to 'seqwt'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/seqwt"
    ...
    def get_bin(self):
        """Method to get the path to 'seqwt'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'seqwt'"""
    ...
    def monitor(self):
        """
        Method to read output of seqwt and check if it has finished.
