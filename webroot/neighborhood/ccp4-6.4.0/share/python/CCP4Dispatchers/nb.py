...
class Dispatcher:
    """A class to handle dispatch to 'nb'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/nb"
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'nb'"""
    ...
    def monitor(self):
        """
        Method to read output of nb and check if it has finished.
