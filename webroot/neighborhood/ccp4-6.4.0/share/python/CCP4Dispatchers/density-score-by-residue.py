...
#
"""CCP4 dispatcher for 'density-score-by-residue'"""
...
class Dispatcher:
    """A class to handle dispatch to 'density-score-by-residue'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "density-score-by-residue"

        # A string giving the command required for dispatch
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/density-score-by-residue"
    ...
    def get_bin(self):
        """Method to get the path to 'density-score-by-residue'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'density-score-by-residue'"""
    ...
    def call(self, wait=True):
        """
        Method to execute density-score-by-residue.
    ...
    def monitor(self):
        """
        Method to read output of density-score-by-residue and check if it has finished.
