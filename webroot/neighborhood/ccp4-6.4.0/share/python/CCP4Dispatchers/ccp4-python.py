...
#
"""CCP4 dispatcher for 'ccp4-python'"""
...
class Dispatcher:
    """A class to handle dispatch to 'ccp4-python'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "ccp4-python"

        # A string giving the command required for dispatch
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ccp4-python"
    ...
    def get_bin(self):
        """Method to get the path to 'ccp4-python'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ccp4-python'"""
    ...
    def monitor(self):
        """
        Method to read output of ccp4-python and check if it has finished.
