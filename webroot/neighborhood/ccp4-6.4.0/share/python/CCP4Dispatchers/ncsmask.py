...
class Dispatcher:
    """A class to handle dispatch to 'ncsmask'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ncsmask"
    ...
    def get_bin(self):
        """Method to get the path to 'ncsmask'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ncsmask'"""
    ...
    def monitor(self):
        """
        Method to read output of ncsmask and check if it has finished.
