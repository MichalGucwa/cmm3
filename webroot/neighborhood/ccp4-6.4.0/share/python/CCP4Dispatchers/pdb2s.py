...
class Dispatcher:
    """A class to handle dispatch to 'pdb2s'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdb2s"
    ...
    def get_bin(self):
        """Method to get the path to 'pdb2s'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdb2s'"""
    ...
    def monitor(self):
        """
        Method to read output of pdb2s and check if it has finished.
