...
class Dispatcher:
    """A class to handle dispatch to 'pdbcur'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdbcur"
    ...
    def get_bin(self):
        """Method to get the path to 'pdbcur'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdbcur'"""
    ...
    def monitor(self):
        """
        Method to read output of pdbcur and check if it has finished.
