...
#
"""CCP4 dispatcher for 'get-residue-stats.pl'"""
...
class Dispatcher:
    """A class to handle dispatch to 'get-residue-stats.pl'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "get-residue-stats.pl"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/perl -w /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/get-residue-stats.pl"
    ...
    def get_bin(self):
        """Method to get the path to 'get-residue-stats.pl'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'get-residue-stats.pl'"""
    ...
    def call(self, wait=True):
        """
        Method to execute get-residue-stats.pl.
    ...
    def monitor(self):
        """
        Method to read output of get-residue-stats.pl and check if it has finished.
