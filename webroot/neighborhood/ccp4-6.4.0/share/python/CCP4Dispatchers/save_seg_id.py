...
#
"""CCP4 dispatcher for 'save_seg_id'"""
...
class Dispatcher:
    """A class to handle dispatch to 'save_seg_id'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "save_seg_id"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/save_seg_id"
    ...
    def get_bin(self):
        """Method to get the path to 'save_seg_id'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'save_seg_id'"""
    ...
    def monitor(self):
        """
        Method to read output of save_seg_id and check if it has finished.
