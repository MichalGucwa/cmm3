...
#
"""CCP4 dispatcher for 'mapreplace'"""
...
class Dispatcher:
    """A class to handle dispatch to 'mapreplace'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "mapreplace"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mapreplace"
    ...
    def get_bin(self):
        """Method to get the path to 'mapreplace'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mapreplace'"""
    ...
    def monitor(self):
        """
        Method to read output of mapreplace and check if it has finished.
