...
class Dispatcher:
    """A class to handle dispatch to 'coordconv'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/coordconv"
    ...
    def get_bin(self):
        """Method to get the path to 'coordconv'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'coordconv'"""
    ...
    def monitor(self):
        """
        Method to read output of coordconv and check if it has finished.
