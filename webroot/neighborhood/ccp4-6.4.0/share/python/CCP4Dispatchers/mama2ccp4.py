...
class Dispatcher:
    """A class to handle dispatch to 'mama2ccp4'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mama2ccp4"
    ...
    def get_bin(self):
        """Method to get the path to 'mama2ccp4'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mama2ccp4'"""
    ...
    def monitor(self):
        """
        Method to read output of mama2ccp4 and check if it has finished.
