...
class Dispatcher:
    """A class to handle dispatch to 'bp3'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/bp3"
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'bp3'"""
    ...
    def monitor(self):
        """
        Method to read output of bp3 and check if it has finished.
