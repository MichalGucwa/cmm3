...
#
"""CCP4 dispatcher for 'scalepack2mtz'"""
...
class Dispatcher:
    """A class to handle dispatch to 'scalepack2mtz'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "scalepack2mtz"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/scalepack2mtz"
    ...
    def get_bin(self):
        """Method to get the path to 'scalepack2mtz'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'scalepack2mtz'"""
    ...
    def call(self, wait=True):
        """
        Method to execute scalepack2mtz.
    ...
    def monitor(self):
        """
        Method to read output of scalepack2mtz and check if it has finished.
