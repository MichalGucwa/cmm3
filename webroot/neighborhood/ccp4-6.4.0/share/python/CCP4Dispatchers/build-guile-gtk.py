...
#
"""CCP4 dispatcher for 'build-guile-gtk'"""
...
class Dispatcher:
    """A class to handle dispatch to 'build-guile-gtk'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "build-guile-gtk"

        # A string giving the command required for dispatch
        self.command = " /bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/build-guile-gtk"
    ...
    def get_bin(self):
        """Method to get the path to 'build-guile-gtk'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'build-guile-gtk'"""
    ...
    def call(self, wait=True):
        """
        Method to execute build-guile-gtk.
    ...
    def monitor(self):
        """
        Method to read output of build-guile-gtk and check if it has finished.
