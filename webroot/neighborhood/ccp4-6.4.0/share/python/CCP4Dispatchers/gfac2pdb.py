...
class Dispatcher:
    """A class to handle dispatch to 'gfac2pdb'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/gfac2pdb"
    ...
    def get_bin(self):
        """Method to get the path to 'gfac2pdb'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'gfac2pdb'"""
    ...
    def monitor(self):
        """
        Method to read output of gfac2pdb and check if it has finished.
