...
class Dispatcher:
    """A class to handle dispatch to 'vecsum'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/vecsum"
    ...
    def get_bin(self):
        """Method to get the path to 'vecsum'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'vecsum'"""
    ...
    def monitor(self):
        """
        Method to read output of vecsum and check if it has finished.
