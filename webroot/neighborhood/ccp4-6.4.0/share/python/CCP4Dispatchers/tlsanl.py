...
class Dispatcher:
    """A class to handle dispatch to 'tlsanl'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/tlsanl"
    ...
    def get_bin(self):
        """Method to get the path to 'tlsanl'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'tlsanl'"""
    ...
    def monitor(self):
        """
        Method to read output of tlsanl and check if it has finished.
