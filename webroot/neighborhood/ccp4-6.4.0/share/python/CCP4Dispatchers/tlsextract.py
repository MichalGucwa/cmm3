...
#
"""CCP4 dispatcher for 'tlsextract'"""
...
class Dispatcher:
    """A class to handle dispatch to 'tlsextract'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "tlsextract"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/tlsextract"
    ...
    def get_bin(self):
        """Method to get the path to 'tlsextract'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'tlsextract'"""
    ...
    def monitor(self):
        """
        Method to read output of tlsextract and check if it has finished.
