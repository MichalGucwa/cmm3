...
class Dispatcher:
    """A class to handle dispatch to 'get_chain'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/get_chain"
    ...
    def get_bin(self):
        """Method to get the path to 'get_chain'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'get_chain'"""
    ...
    def monitor(self):
        """
        Method to read output of get_chain and check if it has finished.
