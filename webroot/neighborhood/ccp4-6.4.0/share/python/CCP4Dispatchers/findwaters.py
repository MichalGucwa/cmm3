...
#
"""CCP4 dispatcher for 'findwaters'"""
...
class Dispatcher:
    """A class to handle dispatch to 'findwaters'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "findwaters"

        # A string giving the command required for dispatch
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/findwaters"
    ...
    def get_bin(self):
        """Method to get the path to 'findwaters'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'findwaters'"""
    ...
    def monitor(self):
        """
        Method to read output of findwaters and check if it has finished.
