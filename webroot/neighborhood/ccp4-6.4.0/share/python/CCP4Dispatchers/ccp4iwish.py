...
class Dispatcher:
    """A class to handle dispatch to 'ccp4iwish'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ccp4iwish"
    ...
    def get_bin(self):
        """Method to get the path to 'ccp4iwish'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ccp4iwish'"""
    ...
    def monitor(self):
        """
        Method to read output of ccp4iwish and check if it has finished.
