...
#
"""CCP4 dispatcher for 'rwcontents'"""
...
class Dispatcher:
    """A class to handle dispatch to 'rwcontents'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "rwcontents"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/rwcontents"
    ...
    def get_bin(self):
        """Method to get the path to 'rwcontents'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'rwcontents'"""
    ...
    def monitor(self):
        """
        Method to read output of rwcontents and check if it has finished.
