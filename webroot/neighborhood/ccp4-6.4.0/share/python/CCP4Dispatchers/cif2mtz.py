...
class Dispatcher:
    """A class to handle dispatch to 'cif2mtz'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cif2mtz"
    ...
    def get_bin(self):
        """Method to get the path to 'cif2mtz'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cif2mtz'"""
    ...
    def monitor(self):
        """
        Method to read output of cif2mtz and check if it has finished.
