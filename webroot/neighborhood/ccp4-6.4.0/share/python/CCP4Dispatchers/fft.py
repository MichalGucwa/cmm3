...
class Dispatcher:
    """A class to handle dispatch to 'fft'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/fft"
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'fft'"""
    ...
    def monitor(self):
        """
        Method to read output of fft and check if it has finished.
