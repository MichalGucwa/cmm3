...
class Dispatcher:
    """A class to handle dispatch to 'mtz2cif'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mtz2cif"
    ...
    def get_bin(self):
        """Method to get the path to 'mtz2cif'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mtz2cif'"""
    ...
    def monitor(self):
        """
        Method to read output of mtz2cif and check if it has finished.
