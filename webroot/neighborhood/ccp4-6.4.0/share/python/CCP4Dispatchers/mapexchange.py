...
#
"""CCP4 dispatcher for 'mapexchange'"""
...
class Dispatcher:
    """A class to handle dispatch to 'mapexchange'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "mapexchange"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mapexchange"
    ...
    def get_bin(self):
        """Method to get the path to 'mapexchange'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mapexchange'"""
    ...
    def monitor(self):
        """
        Method to read output of mapexchange and check if it has finished.
