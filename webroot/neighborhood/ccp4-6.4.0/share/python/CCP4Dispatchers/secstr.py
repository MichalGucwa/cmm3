...
class Dispatcher:
    """A class to handle dispatch to 'secstr'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/secstr"
    ...
    def get_bin(self):
        """Method to get the path to 'secstr'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'secstr'"""
    ...
    def monitor(self):
        """
        Method to read output of secstr and check if it has finished.
