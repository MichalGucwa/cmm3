...
#
"""CCP4 dispatcher for 'edstats.pl'"""
...
class Dispatcher:
    """A class to handle dispatch to 'edstats.pl'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "edstats.pl"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/perl -w /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/edstats.pl"
    ...
    def get_bin(self):
        """Method to get the path to 'edstats.pl'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'edstats.pl'"""
    ...
    def monitor(self):
        """
        Method to read output of edstats.pl and check if it has finished.
