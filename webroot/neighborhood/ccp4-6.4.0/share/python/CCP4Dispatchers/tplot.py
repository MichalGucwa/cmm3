...
class Dispatcher:
    """A class to handle dispatch to 'tplot'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/tplot"
    ...
    def get_bin(self):
        """Method to get the path to 'tplot'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'tplot'"""
    ...
    def monitor(self):
        """
        Method to read output of tplot and check if it has finished.
