...
#
"""CCP4 dispatcher for 'check_cell_sg'"""
...
class Dispatcher:
    """A class to handle dispatch to 'check_cell_sg'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "check_cell_sg"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/check_cell_sg"
    ...
    def get_bin(self):
        """Method to get the path to 'check_cell_sg'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'check_cell_sg'"""
    ...
    def call(self, wait=True):
        """
        Method to execute check_cell_sg.
    ...
    def monitor(self):
        """
        Method to read output of check_cell_sg and check if it has finished.
