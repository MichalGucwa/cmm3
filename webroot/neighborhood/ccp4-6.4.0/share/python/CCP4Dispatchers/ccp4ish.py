...
class Dispatcher:
    """A class to handle dispatch to 'ccp4ish'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ccp4ish"
    ...
    def get_bin(self):
        """Method to get the path to 'ccp4ish'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ccp4ish'"""
    ...
    def monitor(self):
        """
        Method to read output of ccp4ish and check if it has finished.
