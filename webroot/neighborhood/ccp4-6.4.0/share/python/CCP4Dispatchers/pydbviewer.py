...
#
"""CCP4 dispatcher for 'pydbviewer'"""
...
class Dispatcher:
    """A class to handle dispatch to 'pydbviewer'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "pydbviewer"

        # A string giving the command required for dispatch
        self.command = " /usr/bin/env python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pydbviewer"
    ...
    def get_bin(self):
        """Method to get the path to 'pydbviewer'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pydbviewer'"""
    ...
    def monitor(self):
        """
        Method to read output of pydbviewer and check if it has finished.
