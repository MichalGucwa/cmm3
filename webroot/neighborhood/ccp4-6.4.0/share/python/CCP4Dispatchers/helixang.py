...
class Dispatcher:
    """A class to handle dispatch to 'helixang'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/helixang"
    ...
    def get_bin(self):
        """Method to get the path to 'helixang'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'helixang'"""
    ...
    def monitor(self):
        """
        Method to read output of helixang and check if it has finished.
