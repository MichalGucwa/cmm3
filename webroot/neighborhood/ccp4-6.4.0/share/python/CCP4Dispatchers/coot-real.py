...
class Dispatcher:
    """A class to handle dispatch to 'coot-real'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/coot-real"
    ...
    def get_bin(self):
        """Method to get the path to 'coot-real'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'coot-real'"""
    ...
    def monitor(self):
        """
        Method to read output of coot-real and check if it has finished.
