...
class Dispatcher:
    """A class to handle dispatch to 'diff2jpeg'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/diff2jpeg"
    ...
    def get_bin(self):
        """Method to get the path to 'diff2jpeg'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'diff2jpeg'"""
    ...
    def monitor(self):
        """
        Method to read output of diff2jpeg and check if it has finished.
