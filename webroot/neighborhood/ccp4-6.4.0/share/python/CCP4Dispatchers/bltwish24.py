...
class Dispatcher:
    """A class to handle dispatch to 'bltwish24'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/bltwish24"
    ...
    def get_bin(self):
        """Method to get the path to 'bltwish24'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'bltwish24'"""
    ...
    def monitor(self):
        """
        Method to read output of bltwish24 and check if it has finished.
