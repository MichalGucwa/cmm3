...
#
"""CCP4 dispatcher for 'phaser.ensembler'"""
...
class Dispatcher:
    """A class to handle dispatch to 'phaser.ensembler'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "phaser.ensembler"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/phaser.ensembler"
    ...
    def get_bin(self):
        """Method to get the path to 'phaser.ensembler'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'phaser.ensembler'"""
    ...
    def call(self, wait=True):
        """
        Method to execute phaser.ensembler.
    ...
    def monitor(self):
        """
        Method to read output of phaser.ensembler and check if it has finished.
