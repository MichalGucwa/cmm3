...
#
"""CCP4 dispatcher for 'printpeaks'"""
...
class Dispatcher:
    """A class to handle dispatch to 'printpeaks'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "printpeaks"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/printpeaks"
    ...
    def get_bin(self):
        """Method to get the path to 'printpeaks'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'printpeaks'"""
    ...
    def monitor(self):
        """
        Method to read output of printpeaks and check if it has finished.
