...
#
"""CCP4 dispatcher for 'solution_check'"""
...
class Dispatcher:
    """A class to handle dispatch to 'solution_check'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "solution_check"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/solution_check"
    ...
    def get_bin(self):
        """Method to get the path to 'solution_check'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'solution_check'"""
    ...
    def call(self, wait=True):
        """
        Method to execute solution_check.
    ...
    def monitor(self):
        """
        Method to read output of solution_check and check if it has finished.
