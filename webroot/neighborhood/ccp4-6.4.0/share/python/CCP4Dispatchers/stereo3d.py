...
class Dispatcher:
    """A class to handle dispatch to 'stereo3d'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/stereo3d"
    ...
    def get_bin(self):
        """Method to get the path to 'stereo3d'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'stereo3d'"""
    ...
    def monitor(self):
        """
        Method to read output of stereo3d and check if it has finished.
