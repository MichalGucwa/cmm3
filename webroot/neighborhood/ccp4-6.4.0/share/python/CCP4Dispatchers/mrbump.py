...
class Dispatcher:
    """A class to handle dispatch to 'mrbump'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/usr/bin/env ccp4-python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mrbump"
    ...
    def get_bin(self):
        """Method to get the path to 'mrbump'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mrbump'"""
    ...
    def monitor(self):
        """
        Method to read output of mrbump and check if it has finished.
