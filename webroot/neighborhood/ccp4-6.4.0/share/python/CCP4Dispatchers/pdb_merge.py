...
class Dispatcher:
    """A class to handle dispatch to 'pdb_merge'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdb_merge"
    ...
    def get_bin(self):
        """Method to get the path to 'pdb_merge'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdb_merge'"""
    ...
    def monitor(self):
        """
        Method to read output of pdb_merge and check if it has finished.
