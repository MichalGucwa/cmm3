...
#
"""CCP4 dispatcher for 'cncsfrommodel'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cncsfrommodel'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cncsfrommodel"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cncsfrommodel"
    ...
    def get_bin(self):
        """Method to get the path to 'cncsfrommodel'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cncsfrommodel'"""
    ...
    def call(self, wait=True):
        """
        Method to execute cncsfrommodel.
    ...
    def monitor(self):
        """
        Method to read output of cncsfrommodel and check if it has finished.
