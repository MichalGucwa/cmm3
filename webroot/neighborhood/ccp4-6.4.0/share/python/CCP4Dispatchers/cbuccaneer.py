...
#
"""CCP4 dispatcher for 'cbuccaneer'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cbuccaneer'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cbuccaneer"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cbuccaneer"
    ...
    def get_bin(self):
        """Method to get the path to 'cbuccaneer'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cbuccaneer'"""
    ...
    def monitor(self):
        """
        Method to read output of cbuccaneer and check if it has finished.
