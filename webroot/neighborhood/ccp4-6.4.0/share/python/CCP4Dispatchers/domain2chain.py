...
#
"""CCP4 dispatcher for 'domain2chain'"""
...
class Dispatcher:
    """A class to handle dispatch to 'domain2chain'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "domain2chain"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/domain2chain"
    ...
    def get_bin(self):
        """Method to get the path to 'domain2chain'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'domain2chain'"""
    ...
    def call(self, wait=True):
        """
        Method to execute domain2chain.
    ...
    def monitor(self):
        """
        Method to read output of domain2chain and check if it has finished.
