...
#
"""CCP4 dispatcher for 'nautilus_pipeline'"""
...
class Dispatcher:
    """A class to handle dispatch to 'nautilus_pipeline'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "nautilus_pipeline"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/env ccp4-python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/nautilus_pipeline"
    ...
    def get_bin(self):
        """Method to get the path to 'nautilus_pipeline'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'nautilus_pipeline'"""
    ...
    def call(self, wait=True):
        """
        Method to execute nautilus_pipeline.
    ...
    def monitor(self):
        """
        Method to read output of nautilus_pipeline and check if it has finished.
