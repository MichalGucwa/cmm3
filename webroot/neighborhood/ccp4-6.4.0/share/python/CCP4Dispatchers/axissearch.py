...
#
"""CCP4 dispatcher for 'axissearch'"""
...
class Dispatcher:
    """A class to handle dispatch to 'axissearch'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "axissearch"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/axissearch"
    ...
    def get_bin(self):
        """Method to get the path to 'axissearch'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'axissearch'"""
    ...
    def monitor(self):
        """
        Method to read output of axissearch and check if it has finished.
