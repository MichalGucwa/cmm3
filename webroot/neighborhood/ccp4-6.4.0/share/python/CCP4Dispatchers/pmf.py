...
class Dispatcher:
    """A class to handle dispatch to 'pmf'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pmf"
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pmf'"""
    ...
    def monitor(self):
        """
        Method to read output of pmf and check if it has finished.
