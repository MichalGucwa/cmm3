...
class Dispatcher:
    """A class to handle dispatch to 'topdraw'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/topdraw"
    ...
    def get_bin(self):
        """Method to get the path to 'topdraw'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'topdraw'"""
    ...
    def monitor(self):
        """
        Method to read output of topdraw and check if it has finished.
