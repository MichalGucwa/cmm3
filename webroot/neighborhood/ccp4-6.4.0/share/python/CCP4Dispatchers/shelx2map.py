...
class Dispatcher:
    """A class to handle dispatch to 'shelx2map'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/shelx2map"
    ...
    def get_bin(self):
        """Method to get the path to 'shelx2map'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'shelx2map'"""
    ...
    def monitor(self):
        """
        Method to read output of shelx2map and check if it has finished.
