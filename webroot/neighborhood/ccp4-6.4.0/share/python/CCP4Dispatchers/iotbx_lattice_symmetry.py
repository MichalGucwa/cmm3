...
#
"""CCP4 dispatcher for 'iotbx.lattice_symmetry'"""
...
class Dispatcher:
    """A class to handle dispatch to 'iotbx.lattice_symmetry'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "iotbx.lattice_symmetry"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/iotbx.lattice_symmetry"
    ...
    def get_bin(self):
        """Method to get the path to 'iotbx.lattice_symmetry'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'iotbx.lattice_symmetry'"""
    ...
    def call(self, wait=True):
        """
        Method to execute iotbx.lattice_symmetry.
    ...
    def monitor(self):
        """
        Method to read output of iotbx.lattice_symmetry and check if it has finished.
