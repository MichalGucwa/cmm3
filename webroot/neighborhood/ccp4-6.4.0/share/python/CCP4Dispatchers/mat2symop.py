...
class Dispatcher:
    """A class to handle dispatch to 'mat2symop'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mat2symop"
    ...
    def get_bin(self):
        """Method to get the path to 'mat2symop'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mat2symop'"""
    ...
    def monitor(self):
        """
        Method to read output of mat2symop and check if it has finished.
