...
class Dispatcher:
    """A class to handle dispatch to 'pplot'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pplot"
    ...
    def get_bin(self):
        """Method to get the path to 'pplot'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pplot'"""
    ...
    def monitor(self):
        """
        Method to read output of pplot and check if it has finished.
