...
class Dispatcher:
    """A class to handle dispatch to 'prep_bulk'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/prep_bulk"
    ...
    def get_bin(self):
        """Method to get the path to 'prep_bulk'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'prep_bulk'"""
    ...
    def monitor(self):
        """
        Method to read output of prep_bulk and check if it has finished.
