...
#
"""CCP4 dispatcher for 'matthews_coef'"""
...
class Dispatcher:
    """A class to handle dispatch to 'matthews_coef'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "matthews_coef"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/matthews_coef"
    ...
    def get_bin(self):
        """Method to get the path to 'matthews_coef'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'matthews_coef'"""
    ...
    def call(self, wait=True):
        """
        Method to execute matthews_coef.
    ...
    def monitor(self):
        """
        Method to read output of matthews_coef and check if it has finished.
