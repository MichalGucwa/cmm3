...
class Dispatcher:
    """A class to handle dispatch to 'crank'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/usr/bin/env tclsh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/crank"
    ...
    def get_bin(self):
        """Method to get the path to 'crank'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'crank'"""
    ...
    def monitor(self):
        """
        Method to read output of crank and check if it has finished.
