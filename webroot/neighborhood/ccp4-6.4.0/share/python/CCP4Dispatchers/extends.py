...
class Dispatcher:
    """A class to handle dispatch to 'extends'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/extends"
    ...
    def get_bin(self):
        """Method to get the path to 'extends'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'extends'"""
    ...
    def monitor(self):
        """
        Method to read output of extends and check if it has finished.
