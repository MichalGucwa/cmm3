...
class Dispatcher:
    """A class to handle dispatch to 'p842asc'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/p842asc"
    ...
    def get_bin(self):
        """Method to get the path to 'p842asc'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'p842asc'"""
    ...
    def monitor(self):
        """
        Method to read output of p842asc and check if it has finished.
