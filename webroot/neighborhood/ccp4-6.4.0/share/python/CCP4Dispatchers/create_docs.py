...
#
"""CCP4 dispatcher for 'create_docs'"""
...
class Dispatcher:
    """A class to handle dispatch to 'create_docs'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "create_docs"

        # A string giving the command required for dispatch
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/create_docs"
    ...
    def get_bin(self):
        """Method to get the path to 'create_docs'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'create_docs'"""
    ...
    def monitor(self):
        """
        Method to read output of create_docs and check if it has finished.
