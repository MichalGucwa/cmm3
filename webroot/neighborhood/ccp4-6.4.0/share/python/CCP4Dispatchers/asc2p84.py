...
class Dispatcher:
    """A class to handle dispatch to 'asc2p84'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/asc2p84"
    ...
    def get_bin(self):
        """Method to get the path to 'asc2p84'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'asc2p84'"""
    ...
    def monitor(self):
        """
        Method to read output of asc2p84 and check if it has finished.
