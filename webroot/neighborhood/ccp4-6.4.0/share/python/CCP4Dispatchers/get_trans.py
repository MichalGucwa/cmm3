...
class Dispatcher:
    """A class to handle dispatch to 'get_trans'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/get_trans"
    ...
    def get_bin(self):
        """Method to get the path to 'get_trans'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'get_trans'"""
    ...
    def monitor(self):
        """
        Method to read output of get_trans and check if it has finished.
