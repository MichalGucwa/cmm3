...
class Dispatcher:
    """A class to handle dispatch to 'worms'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/bin/csh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/worms"
    ...
    def get_bin(self):
        """Method to get the path to 'worms'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'worms'"""
    ...
    def monitor(self):
        """
        Method to read output of worms and check if it has finished.
