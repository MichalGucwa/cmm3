...
#
"""CCP4 dispatcher for 'cmodeltoseq'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cmodeltoseq'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cmodeltoseq"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cmodeltoseq"
    ...
    def get_bin(self):
        """Method to get the path to 'cmodeltoseq'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cmodeltoseq'"""
    ...
    def monitor(self):
        """
        Method to read output of cmodeltoseq and check if it has finished.
