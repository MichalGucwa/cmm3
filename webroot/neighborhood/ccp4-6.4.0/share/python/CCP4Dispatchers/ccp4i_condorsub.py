...
#
"""CCP4 dispatcher for 'ccp4i_condorsub'"""
...
class Dispatcher:
    """A class to handle dispatch to 'ccp4i_condorsub'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "ccp4i_condorsub"

        # A string giving the command required for dispatch
        self.command = "/bin/sh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ccp4i_condorsub"
    ...
    def get_bin(self):
        """Method to get the path to 'ccp4i_condorsub'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ccp4i_condorsub'"""
    ...
    def call(self, wait=True):
        """
        Method to execute ccp4i_condorsub.
    ...
    def monitor(self):
        """
        Method to read output of ccp4i_condorsub and check if it has finished.
