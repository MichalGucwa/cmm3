...
#
"""CCP4 dispatcher for 'cctbx.python'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cctbx.python'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cctbx.python"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cctbx.python"
    ...
    def get_bin(self):
        """Method to get the path to 'cctbx.python'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cctbx.python'"""
    ...
    def call(self, wait=True):
        """
        Method to execute cctbx.python.
    ...
    def monitor(self):
        """
        Method to read output of cctbx.python and check if it has finished.
