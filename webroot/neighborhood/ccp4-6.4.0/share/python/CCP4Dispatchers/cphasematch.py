...
#
"""CCP4 dispatcher for 'cphasematch'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cphasematch'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cphasematch"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cphasematch"
    ...
    def get_bin(self):
        """Method to get the path to 'cphasematch'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cphasematch'"""
    ...
    def monitor(self):
        """
        Method to read output of cphasematch and check if it has finished.
