...
#
"""CCP4 dispatcher for 'siras_0atoms_hack'"""
...
class Dispatcher:
    """A class to handle dispatch to 'siras_0atoms_hack'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "siras_0atoms_hack"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/perl /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/siras_0atoms_hack"
    ...
    def get_bin(self):
        """Method to get the path to 'siras_0atoms_hack'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'siras_0atoms_hack'"""
    ...
    def call(self, wait=True):
        """
        Method to execute siras_0atoms_hack.
    ...
    def monitor(self):
        """
        Method to read output of siras_0atoms_hack and check if it has finished.
