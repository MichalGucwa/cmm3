...
class Dispatcher:
    """A class to handle dispatch to 'pdb_pack'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/pdb_pack"
    ...
    def get_bin(self):
        """Method to get the path to 'pdb_pack'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdb_pack'"""
    ...
    def monitor(self):
        """
        Method to read output of pdb_pack and check if it has finished.
