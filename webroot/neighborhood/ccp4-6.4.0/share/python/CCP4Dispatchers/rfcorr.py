...
class Dispatcher:
    """A class to handle dispatch to 'rfcorr'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/rfcorr"
    ...
    def get_bin(self):
        """Method to get the path to 'rfcorr'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'rfcorr'"""
    ...
    def monitor(self):
        """
        Method to read output of rfcorr and check if it has finished.
