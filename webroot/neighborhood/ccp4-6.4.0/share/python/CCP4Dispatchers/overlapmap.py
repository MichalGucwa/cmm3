...
#
"""CCP4 dispatcher for 'overlapmap'"""
...
class Dispatcher:
    """A class to handle dispatch to 'overlapmap'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "overlapmap"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/overlapmap"
    ...
    def get_bin(self):
        """Method to get the path to 'overlapmap'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'overlapmap'"""
    ...
    def monitor(self):
        """
        Method to read output of overlapmap and check if it has finished.
