...
class Dispatcher:
    """A class to handle dispatch to 'mtzinfo'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mtzinfo"
    ...
    def get_bin(self):
        """Method to get the path to 'mtzinfo'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mtzinfo'"""
    ...
    def monitor(self):
        """
        Method to read output of mtzinfo and check if it has finished.
