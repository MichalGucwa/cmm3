...
#
"""CCP4 dispatcher for 'coord_format'"""
...
class Dispatcher:
    """A class to handle dispatch to 'coord_format'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "coord_format"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/coord_format"
    ...
    def get_bin(self):
        """Method to get the path to 'coord_format'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'coord_format'"""
    ...
    def call(self, wait=True):
        """
        Method to execute coord_format.
    ...
    def monitor(self):
        """
        Method to read output of coord_format and check if it has finished.
