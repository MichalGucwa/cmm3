...
class Dispatcher:
    """A class to handle dispatch to 'stereo'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/stereo"
    ...
    def get_bin(self):
        """Method to get the path to 'stereo'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'stereo'"""
    ...
    def monitor(self):
        """
        Method to read output of stereo and check if it has finished.
