...
class Dispatcher:
    """A class to handle dispatch to 'sftools'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/sftools"
    ...
    def get_bin(self):
        """Method to get the path to 'sftools'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'sftools'"""
    ...
    def monitor(self):
        """
        Method to read output of sftools and check if it has finished.
