...
class Dispatcher:
    """A class to handle dispatch to 'refindex'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/refindex"
    ...
    def get_bin(self):
        """Method to get the path to 'refindex'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'refindex'"""
    ...
    def monitor(self):
        """
        Method to read output of refindex and check if it has finished.
