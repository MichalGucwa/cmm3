...
#
"""CCP4 dispatcher for 'ccp4_pipeline_simple'"""
...
class Dispatcher:
    """A class to handle dispatch to 'ccp4_pipeline_simple'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "ccp4_pipeline_simple"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/env ccp4-python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ccp4_pipeline_simple"
    ...
    def get_bin(self):
        """Method to get the path to 'ccp4_pipeline_simple'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ccp4_pipeline_simple'"""
    ...
    def call(self, wait=True):
        """
        Method to execute ccp4_pipeline_simple.
    ...
    def monitor(self):
        """
        Method to read output of ccp4_pipeline_simple and check if it has finished.
