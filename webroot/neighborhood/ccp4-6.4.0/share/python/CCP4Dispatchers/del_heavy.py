...
class Dispatcher:
    """A class to handle dispatch to 'del_heavy'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/usr/bin/env tclsh /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/del_heavy"
    ...
    def get_bin(self):
        """Method to get the path to 'del_heavy'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'del_heavy'"""
    ...
    def monitor(self):
        """
        Method to read output of del_heavy and check if it has finished.
