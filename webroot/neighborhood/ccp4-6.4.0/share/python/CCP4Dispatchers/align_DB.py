...
class Dispatcher:
    """A class to handle dispatch to 'align_DB'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/align_DB"
    ...
    def get_bin(self):
        """Method to get the path to 'align_DB'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'align_DB'"""
    ...
    def monitor(self):
        """
        Method to read output of align_DB and check if it has finished.
