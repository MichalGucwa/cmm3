...
#
"""CCP4 dispatcher for 'cross_validate'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cross_validate'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cross_validate"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cross_validate"
    ...
    def get_bin(self):
        """Method to get the path to 'cross_validate'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cross_validate'"""
    ...
    def call(self, wait=True):
        """
        Method to execute cross_validate.
    ...
    def monitor(self):
        """
        Method to read output of cross_validate and check if it has finished.
