...
#
"""CCP4 dispatcher for 'check_zero_res.py'"""
...
class Dispatcher:
    """A class to handle dispatch to 'check_zero_res.py'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "check_zero_res.py"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/check_zero_res.py"
    ...
    def get_bin(self):
        """Method to get the path to 'check_zero_res.py'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'check_zero_res.py'"""
    ...
    def call(self, wait=True):
        """
        Method to execute check_zero_res.py.
    ...
    def monitor(self):
        """
        Method to read output of check_zero_res.py and check if it has finished.
