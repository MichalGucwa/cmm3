...
class Dispatcher:
    """A class to handle dispatch to 'balbes'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/usr/bin/python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/balbes"
    ...
    def get_bin(self):
        """Method to get the path to 'balbes'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'balbes'"""
    ...
    def monitor(self):
        """
        Method to read output of balbes and check if it has finished.
