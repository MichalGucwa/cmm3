...
#
"""CCP4 dispatcher for 'ccp4um-bin'"""
...
class Dispatcher:
    """A class to handle dispatch to 'ccp4um-bin'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "ccp4um-bin"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ccp4um-bin"
    ...
    def get_bin(self):
        """Method to get the path to 'ccp4um-bin'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ccp4um-bin'"""
    ...
    def monitor(self):
        """
        Method to read output of ccp4um-bin and check if it has finished.
