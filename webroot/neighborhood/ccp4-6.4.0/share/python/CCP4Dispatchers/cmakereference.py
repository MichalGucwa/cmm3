...
#
"""CCP4 dispatcher for 'cmakereference'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cmakereference'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "cmakereference"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cmakereference"
    ...
    def get_bin(self):
        """Method to get the path to 'cmakereference'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cmakereference'"""
    ...
    def call(self, wait=True):
        """
        Method to execute cmakereference.
    ...
    def monitor(self):
        """
        Method to read output of cmakereference and check if it has finished.
