...
class Dispatcher:
    """A class to handle dispatch to 'bltsh'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/bltsh"
    ...
    def get_bin(self):
        """Method to get the path to 'bltsh'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'bltsh'"""
    ...
    def monitor(self):
        """
        Method to read output of bltsh and check if it has finished.
