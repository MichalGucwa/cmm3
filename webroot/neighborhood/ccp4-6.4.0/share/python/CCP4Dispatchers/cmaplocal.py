...
class Dispatcher:
    """A class to handle dispatch to 'cmaplocal'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/cmaplocal"
    ...
    def get_bin(self):
        """Method to get the path to 'cmaplocal'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cmaplocal'"""
    ...
    def monitor(self):
        """
        Method to read output of cmaplocal and check if it has finished.
