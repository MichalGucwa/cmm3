...
#
"""CCP4 dispatcher for 'check_zero_res'"""
...
class Dispatcher:
    """A class to handle dispatch to 'check_zero_res'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "check_zero_res"

        # A string giving the command required for dispatch
        self.command = "/usr/bin/perl /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/check_zero_res"
    ...
    def get_bin(self):
        """Method to get the path to 'check_zero_res'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'check_zero_res'"""
    ...
    def call(self, wait=True):
        """
        Method to execute check_zero_res.
    ...
    def monitor(self):
        """
        Method to read output of check_zero_res and check if it has finished.
