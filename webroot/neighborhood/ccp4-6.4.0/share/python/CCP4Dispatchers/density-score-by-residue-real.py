...
#
"""CCP4 dispatcher for 'density-score-by-residue-real'"""
...
class Dispatcher:
    """A class to handle dispatch to 'density-score-by-residue-real'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "density-score-by-residue-real"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/density-score-by-residue-real"
    ...
    def get_bin(self):
        """Method to get the path to 'density-score-by-residue-real'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'density-score-by-residue-real'"""
    ...
    def call(self, wait=True):
        """
        Method to execute density-score-by-residue-real.
    ...
    def monitor(self):
        """
        Method to read output of density-score-by-residue-real and check if it has finished.
