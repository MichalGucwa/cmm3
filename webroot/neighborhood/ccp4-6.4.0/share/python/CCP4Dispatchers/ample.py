...
class Dispatcher:
    """A class to handle dispatch to 'ample'"""
    ...
    def __init__(self, capture_streams = True, stdout = None, stderr = None):
        ...
        self.command = "/usr/bin/env python /home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/ample"
    ...
    def get_bin(self):
        """Method to get the path to 'ample'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'ample'"""
    ...
    def monitor(self):
        """
        Method to read output of ample and check if it has finished.
