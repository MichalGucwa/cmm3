...
#
"""CCP4 dispatcher for 'prosmart_align'"""
...
class Dispatcher:
    """A class to handle dispatch to 'prosmart_align'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "prosmart_align"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/prosmart_align"
    ...
    def get_bin(self):
        """Method to get the path to 'prosmart_align'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'prosmart_align'"""
    ...
    def call(self, wait=True):
        """
        Method to execute prosmart_align.
    ...
    def monitor(self):
        """
        Method to read output of prosmart_align and check if it has finished.
