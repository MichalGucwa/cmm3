...
#
"""CCP4 dispatcher for 'find-blobs'"""
...
class Dispatcher:
    """A class to handle dispatch to 'find-blobs'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "find-blobs"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/find-blobs"
    ...
    def get_bin(self):
        """Method to get the path to 'find-blobs'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'find-blobs'"""
    ...
    def monitor(self):
        """
        Method to read output of find-blobs and check if it has finished.
