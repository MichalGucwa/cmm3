...
#
"""CCP4 dispatcher for 'mtz2various'"""
...
class Dispatcher:
    """A class to handle dispatch to 'mtz2various'"""

    def __init__(self, capture_streams = True, stdout = None, stderr = None):

        self.prog = "mtz2various"

        # A string giving the command required for dispatch
        self.command = "/home/dust/ccp4-6.4.0/ccp4-6.4.0/bin/mtz2various"
    ...
    def get_bin(self):
        """Method to get the path to 'mtz2various'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mtz2various'"""
