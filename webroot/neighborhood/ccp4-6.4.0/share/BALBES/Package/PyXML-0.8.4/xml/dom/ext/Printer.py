...
xml_path0= os.path.join(os.getenv("BALBES_ROOT"),"PyXML-0.8.4/xml/dom/unicode/")
...
import ext
from html import TranslateHtmlCdata
from html import HTML_4_TRANSITIONAL_INLINE
from html import HTML_FORBIDDEN_END
from html import HTML_BOOLEAN_ATTRS
