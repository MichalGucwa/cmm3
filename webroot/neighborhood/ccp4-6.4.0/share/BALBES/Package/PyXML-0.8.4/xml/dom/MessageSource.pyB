...
xml_path2= os.path.join(os.getenv("BALBES_ROOT"),"PyXML-0.8.4/xml")
sys.path.append(xml_path1)
sys.path.append(xml_path2)
# DOMException
from dom_init import INDEX_SIZE_ERR, DOMSTRING_SIZE_ERR , HIERARCHY_REQUEST_ERR
from dom_init import WRONG_DOCUMENT_ERR, INVALID_CHARACTER_ERR, NO_DATA_ALLOWED_ERR
from dom_init import NO_MODIFICATION_ALLOWED_ERR, NOT_FOUND_ERR, NOT_SUPPORTED_ERR
from dom_init import INUSE_ATTRIBUTE_ERR, INVALID_STATE_ERR, SYNTAX_ERR
from dom_init import INVALID_MODIFICATION_ERR, NAMESPACE_ERR, INVALID_ACCESS_ERR
from dom_init import VALIDATION_ERR

# EventException
# from xml.dom import UNSPECIFIED_EVENT_TYPE_ERR
from dom_init import UNSPECIFIED_EVENT_TYPE_ERR

#Range Exceptions
# from xml.dom import BAD_BOUNDARYPOINTS_ERR
# from xml.dom import INVALID_NODE_TYPE_ERR
from dom_init import BAD_BOUNDARYPOINTS_ERR
from dom_init import INVALID_NODE_TYPE_ERR

# Fourthought Exceptions
# from xml.dom import XML_PARSE_ERR
from dom_init import XML_PARSE_ERR

from FtCore import get_translator
