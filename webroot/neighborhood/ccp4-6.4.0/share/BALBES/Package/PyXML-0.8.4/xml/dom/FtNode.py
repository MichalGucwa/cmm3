...
xml_path4= os.path.join(os.getenv("BALBES_ROOT"),"PyXML-0.8.4/xml/utils/")
...
from dom_init import EMPTY_NAMESPACE
from dom_init import NoModificationAllowedErr
from dom_init import NamespaceErr
from dom_init import NotFoundErr
from dom_init import NotSupportedErr
from dom_init import HierarchyRequestErr
from dom_init import WrongDocumentErr
from dom_init import InvalidCharacterErr
# from xml.dom import UnspecifiedEventTypeErr
from dom_init import UnspecifiedEventTypeErr
from dom_init import XML_NAMESPACE
...
def get_name_pattern():
    ...
    try:
        ...
        import characters
        _namePattern = re.compile(characters.Name+'\Z')
    return _namePattern
