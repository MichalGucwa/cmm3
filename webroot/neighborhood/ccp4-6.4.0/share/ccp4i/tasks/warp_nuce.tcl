...
if { $array(NNUC) == "" } {
        WarningMessage "You have to input the number of nucleotides." -button Cancel
}   
...
#--------------------------------------------------------------------
proc warp_nuce_setup { typedefVar arrayname } {
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
proc warp_nuce_task_window { arrayname } {
#--------------------------------------------------------------------

  upvar #0 $arrayname array

  if { [CreateTaskWindow $arrayname  \
        "ARP/wARP Version 7.3.0: DNA/RNA Building" "ARP/wARP DNA and RNA building interface" \
        [ list  "Parameters "\
      "Crystal parameters"  ] ] == 0 } return

  set help_source [file join [GetEnvPath warpdoc] nuce.htm ]
    ...
    CreateInputFileLine line \
      ...
      "MTZ in" \
       ...
       -setfileparam space_group_name SPACE_GROUP \
        ...
        -fileout XYZOUT DIR_XYZOUT "_warp_nuce_" \
...
OpenFolder 1 open
  ...
  CreateLine line \
    message "The total number of nucleotides in the asymmetric unit " \
    label "Number of nucleotides" \
    widget NNUC -oblig \
     message "The total number of residues in the asymmetric unit " \
    label " and number of residues" \
    widget NRES -oblig \
    -command "get_wilson $arrayname" \
    label " in the AU." 
