...
proc rename_input_columns { step mtzin mtzout } {
    ...
    if { [info exists XMLParse([join "crank soap run step=$step resolvedm hlphasing_coefficients " __])] } {
	set phasingcoefficients $XMLParse([join "crank soap run step=$step resolvedm hlphasing_coefficients" __])
    } 
