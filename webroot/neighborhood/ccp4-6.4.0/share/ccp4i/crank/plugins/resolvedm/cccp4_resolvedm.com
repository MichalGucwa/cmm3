#
# RESOLVEDM Section (Density modification)
#
IF { [StringSame $PROGRAM_NAME($I) RESOLVEDM] } 
1   <input>
1      <exp_columns>
LOOP K 1 $N_CRYSTALS
1         <crystal id="$K">
...
1   </output>
1   <resolvedm>
1      <ncs>$RESOLVEDM_NCS($I)</ncs>
1      <hlphasing_coefficients>$RESOLVEDM_HLOUTPUT($I)</hlphasing_coefficients>
1   </resolvedm>
ENDIF
