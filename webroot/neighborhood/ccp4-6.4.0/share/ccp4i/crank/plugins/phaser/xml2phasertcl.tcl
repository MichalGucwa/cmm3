...
#
proc OutputPhasertclfile { executable pdb } {
    global XMLParse
    ...
    puts "\nstop\""
    puts ""
    puts "set command \"\$command << \\\"\$script\\\" > phaser-logfile\""
...
if { [file exists $inputxml] == 0 } {
    crank_error "xml2phasertcl.tcl::inputxml file does not exist"
}

if { [file exists $pdb] == 0 } {
    crank_error "xml2phasertcl.tcl::pdb file does not exist"
}

XMLParsefile $inputxml

OutputPhasertclfile $executable $pdb
