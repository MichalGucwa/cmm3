...
#
IF { [StringSame $PROGRAM_NAME($I) MOLREP] } 
1   <input>
...
1   </output>
1   <brics>
1      <rot_function>$MOLREP_ROT($I)</rot_function>
1      <trans_function>$MOLREP_TRANS($I)</trans_function>
1      <seq_similarity>$MOLREP_SEQ_SIM($I)</seq_similarity>
1   </brics>
ENDIF
