#
# BRICS Section (Molecular replacement)
#
IF { [StringSame $PROGRAM_NAME($I) BRICS] } 
1   <input>
...
1   </output>
1   <brics>
1      <rot_function>$BRICS_ROT($I)</rot_function>
1      <trans_function>$BRICS_TRANS($I)</trans_function>
1      <seq_similarity>$BRICS_SEQ_SIM($I)</seq_similarity>
1   </brics>
ENDIF
