...
#
# A MrBUMP wrapper for CCP4 program Ecalc 
...
class Ecalc:
   ...
   def run(self, hklin, hklout, logfile):
      """ Function to launch a ecalc job for a given MTZ file. """

      # Give a header output
      sys.stdout.write("#######################################\n")
      sys.stdout.write("Running Ecalc\n")
      sys.stdout.write("#######################################\n")
      sys.stdout.write("\n")
      ...
      command_line=self.ecalcEXE + " HKLIN %s HKLOUT %s" % (self.hklin, self.hklout)

      # Display the command line
      if self.local_debug:
         sys.stdout.write("Command line for Ecalc: \n")
      ...
      if self.termination == False: 
         sys.stdout.write("Ecalc Error: ecalc failed to complete successfully\n")
         sys.stdout.write("Log file can be found here:\n")
         sys.stdout.write("   " + self.logfile + "\n")
         sys.stdout.write("\n")
      else:
         sys.stdout.write("Ecalc completed successfully\n")
...
if __name__ == "__main__":
   ...
   ecalc.add_keyword("LABIn FP=F SIGFP=SIGF")
   ecalc.add_keyword("LABOut E=E SIGE=SIGE")
   ecalc.add_keyword("END")
 
   # Ecalc the MTZ file
   ecalc.run("cad_out.mtz", "ecalc_out.mtz", "ecalc.log")
