...
#
"""CCP4 dispatcher for the binary 'molrep'"""
...
class Dispatcher:
    """A class to handle dispatch to 'molrep'"""
    ...
    def __init__(self, communicate = True):
        ...
        #self.command = "/home/rmk65/opt/ccp4/6.2.992/ccp4-6.2.992/bin/molrep"
        if os.name=="nt":
           self.command = os.path.join(os.environ["CCP4"], "bin", "molrep.exe")
        else:
           self.command = os.path.join(os.environ["CCP4"], "bin", "molrep")
...
#        os.environ['_']='/usr/bin/printenv'
    ...
    def get_bin(self):
        """Method to get the path to 'molrep'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'molrep'"""
    ...
    def monitor(self):
        """
        Method to read output of molrep and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute molrep
