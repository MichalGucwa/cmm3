...
#
"""CCP4 dispatcher for the binary 'phaser.sculptor'"""
...
class Dispatcher:
    """A class to handle dispatch to 'phaser.sculptor'"""

    def __init__(self, communicate = True):
        
        self.prog = "phaser.sculptor"
        
        # A string giving the command required for dispatch 
        #self.command = " /bin/sh /home/rmk65/opt/ccp4/6.2.992/ccp4-6.2.992/bin/phaser.sculptor"
        if os.name=="nt":
           self.command = os.path.join(os.environ["CCP4"], "bin", "phaser.sculptor.bat")
        else:
           self.command = os.path.join(os.environ["CCP4"], "bin", "phaser.sculptor")
        ...
        #self.prog_dir_path = "/home/rmk65/opt/ccp4/6.2.992/ccp4-6.2.992/bin"
        self.prog_dir_path = os.path.join(os.environ["CCP4"], "bin")
...
#        os.environ['_']='/usr/bin/printenv'
    ...
    def get_bin(self):
        """Method to get the path to 'phaser.sculptor'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'phaser.sculptor'"""
    ...
    def call(self, wait=True):
        """
        Method to execute phaser.sculptor.
    ...
    def monitor(self):
        """
        Method to read output of phaser.sculptor and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute phaser.sculptor
