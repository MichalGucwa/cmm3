...
set output "/var/www/html/csgid/app/webroot/neighborhood_temp/4dp9/CU--N.png"
...
set y2label "# of CU--N interactions (4dp9)" offset -40,4 rotate by 0
plot "-" using ($1+0.05):2 with boxes lc rgb "#801010" axis x1y2 title "4dp9", \
