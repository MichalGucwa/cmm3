...
static BondValenceDict bondvalence_dictionary[] = {
  ...
  {    15,    20, "Ca", 2, 1.967, 2.45, 2.56, 2.76, 1.842, 2.370, 2.49, 2.72, 2.14, 2.55, 2.62, 1.83, -1},
  ...
  {    22,    27, "Co", 2, 1.692, 2.06, 2.24, 2.46, 1.640, 2.010, 2.18, 2.37, 1.84, 2.21, 2.28, 1.44, 23},
  {    23,    27, "Co", 3, 1.700, 2.06, 2.24, 2.46, 1.620, 2.050, 2.18, 2.37, 1.84, 2.21, 2.28, 1.44, -1},
  ...
  {    28,    29, "Cu", 1, 1.593, 1.86, 2.02, 2.27, 1.600, 1.850, 1.99, 2.16, 1.61, 1.97, 2.08, 1.21, 29},
  {    29,    29, "Cu", 2, 1.679, 1.86, 2.02, 2.27, 1.600, 2.000, 1.99, 2.16, 1.61, 1.97, 2.08, 1.21, -1},
  ...
  {    34,    26, "Fe", 2, 1.734, 2.16, 2.28, 2.53, 1.650, 2.060, 2.26, 2.47, 1.86, 2.27, 2.35, 1.53, 35},
  {    35,    26, "Fe", 3, 1.759, 2.16, 2.28, 2.53, 1.670, 2.090, 2.26, 2.47, 1.86, 2.27, 2.35, 1.53, -1},
  ...
  {    48,    19, "K_", 1, 2.130, 2.59, 2.72, 2.93, 1.990, 2.520, 2.66, 2.88, 2.26, 2.64, 2.83, 2.10, -1},
  ...
  {    52,    12, "Mg", 2, 1.693, 2.18, 2.32, 2.53, 1.581, 2.080, 2.28, 2.46, 1.85, 2.29, 2.38, 1.53, -1},
  ...
  {    60,    11, "Na", 1, 1.800, 2.28, 2.41, 2.64, 1.677, 2.150, 2.33, 2.56, 1.93, 2.36, 2.53, 1.68, -1},
  ...
  {   107,    30, "Zn", 2, 1.704, 2.09, 2.22, 2.45, 1.620, 2.010, 2.15, 2.36, 1.77, 2.15, 2.24, 1.42, -1},
...
void stackPush(ObjNeighborStack *s, ObjResidueInfo *resi1, ObjAtomInfo *atmi1, ObjResidueInfo *resi2, ObjAtomInfo *atmi2);
int  stackContains(ObjNeighborStack *s, ObjResidueInfo *resi1, ObjAtomInfo *atmi1, ObjResidueInfo *resi2, ObjAtomInfo *atmi2);
...
double AtomInfoBondValence(ObjAtomInfo *lig_ai, int bv_index, double distance);
